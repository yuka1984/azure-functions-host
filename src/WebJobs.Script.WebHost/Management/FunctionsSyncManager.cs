...
namespace Microsoft.Azure.WebJobs.Script.WebHost.Management
{
    public sealed class FunctionsSyncManager : IFunctionsSyncManager, IDisposable
    {
        ...
        public FunctionsSyncManager(ScriptHostConfiguration hostConfig, ILoggerFactory loggerFactory, HttpClient httpClient, ISecretManager secretManager, ScriptSettingsManager settings)
        {
        ...
        internal static bool IsSyncTriggersEnvironment(ScriptSettingsManager settings)
        {
            ...
            return !settings.IsCoreToolsEnvironment &&
                !WebScriptHostManager.InStandbyMode && settings.ContainerReady && settings.ConfigurationReady;
        }
