...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class ScriptHostTests : IClassFixture<ScriptHostTests.TestFixture>
    {
        ...
        [Fact]
        public void Initialize_InvalidHostJson_ThrowsInformativeException()
        {
        ...
        public void Initialize_AppliesLoggerConfig()
        {
            ...
            var host = new ScriptHost(environment.Object, eventManager.Object, config);
            host.Initialize();

            // We shouldn't have any log messages
            // We skip checking the startup logger because it gets used before
            // filters are applied
        ...
        public void Initialize_Sanitizes_HostJsonLog()
        {
            ...
            var host = new ScriptHost(environment.Object, eventManager.Object, config, _settingsManager);
            host.Initialize();
