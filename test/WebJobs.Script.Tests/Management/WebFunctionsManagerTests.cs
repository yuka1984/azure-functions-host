...
namespace Microsoft.Azure.WebJobs.Script.Tests.Managment
{
    public class WebFunctionsManagerTests : IDisposable
    {
        ...
        [Fact]
        public void GetScmBaseUrl_ReturnsExpectedValue()
        {
            Assert.Equal("https://localhost", FunctionMetadataExtensions.GetScmBaseUrl());
            ...
            {
                Assert.Equal("https://testapp.scm.azurewebsites.net", FunctionMetadataExtensions.GetScmBaseUrl());
            }
        }
